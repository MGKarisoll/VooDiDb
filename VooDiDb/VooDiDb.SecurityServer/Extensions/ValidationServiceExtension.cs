...
namespace VooDiDb.SecurityServer.Extensions
{
    ...
    {
        public static IEnumerable<ValidationResult> Validate<T>(this IValidationService<T> service, T model,
        ...
        public static object GetService<T>(this IServiceProvider service, Type type, T model,
            ModelStateDictionary modelState) where T : IValidatableObject
        {
